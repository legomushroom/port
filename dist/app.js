	  ...
	  _prototypeProperties(Main, null, {
	    ...
	    initContainer: {
	      value: function initContainer() {
	        var _this = this;
	        setTimeout(function () {
	          window.scrollTo(_this.centerX, _this.centerY);
	        }, 1000);
	      },
	      writable: true,
	      enumerable: true,
	    ...
	    show: {
	      value: function show(el) {
	        ...
	        var timeline2 = new mojs.Timeline({
	          ...
	          onComplete: function () {
	            _this.close.classList.add("is-show");
	          }
	        });
	        var tween = new mojs.Tween();
	        tween.add(timeline);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var floatEqual = __webpack_require__(19).floatEqual
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animation = __webpack_require__(21)
	var Vector = __webpack_require__(8)
	var height = __webpack_require__(19).height
